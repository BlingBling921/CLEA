...
train_pair,test_pair,adj_matrix,r_index,r_val,adj_features,rel_features = load_data('data/zh_en_try/', train_ratio=0.3)
...
model,get_emb = get_model(lr=0.001,dropout_rate=0.30,node_size=node_size,rel_size=rel_size,n_attn_heads = 2,
                          depth=3,gamma = 3,node_hidden=100,rel_hidden = 100,triple_size = triple_size,batch_size = batch_size)
model.summary()
